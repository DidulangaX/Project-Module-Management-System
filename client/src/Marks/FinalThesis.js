...
const FinalThesis = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (groupId && !incompleteStudents.length) {
            try {
                const response = await axios.put('http://localhost:8000/api/students/finalthesis', {
                    groupId,
        ...
        <div>
            ...
            <div>
                <div className="btn-container d-flex justify-content-center align-items-center">
                    ...
                    <Link to="/status-reports/report2" className="btn btn-primary btn-lg mx-2">
                        Status Report 2
                    </Link>
            ...
            <div className="proposal-container">
                <h2 style={{ fontSize: '28px', color: '#124E66', marginTop: '20px', fontWeight: 'bold', textTransform: 'uppercase' }}>Enter Final Thesis marks</h2>
