// CoSupervisorRegistrationForm.js
import './Register.css';
import React, { useState } from 'react';

const CoSupervisorRegistrationForm = ({ role }) => {
  ...
  return (
    <div>
      <h2>Co-Supervisor Registration Form</h2>
...
export default CoSupervisorRegistrationForm;
